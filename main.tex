...
\begin{enumerate}
    ...
    \item The presence of magnetic fields and non-thermal electrons at high galactic latitudes are necessary to explain the synchrotron radiation observed. if m should equipartition exist. %parameters are delicately balanced !
    \item 
