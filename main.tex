...
%This implies that for a magnetic field $B'$ and electron density $n_e'$ and $B'n_e' \propto l^{-n}$ where $n>1$ then $B'n_e'$ will drop as $l$ or $n$ increases. 
