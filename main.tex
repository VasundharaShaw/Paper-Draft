...
\begin{table}[h!]
  \begin{center}
    ...
    \label{Para_table}
    \begin{tabular}{|p{4cm}|p{5cm}|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
    \hline
