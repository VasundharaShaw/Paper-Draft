...
\documentclass[12pt, a4 paper]{mnras}
...
%In this case, $E_{\gamma}^{\mathrm{peak}} = 1.175 \times 10^{-4}$~eV which is corresponding 28.4~GHz, the peak frequency for 30~GHz Planck data.
...
\begin{table*}
\centering
\caption{CAPTION TEXT NEEDED HERE}
